// ============================================================
// assets/supabase.js — creates the ONE real Supabase client for
...
//   2. assets/supabase.js   <-- this file
...
(function () {
  ...
  if (!window.supabase || typeof window.supabase.createClient !== 'function') {
    throw new Error(
      ...
      'from cdn.jsdelivr.net comes BEFORE assets/supabase.js in your HTML.'
    );
  }
